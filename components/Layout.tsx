      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="md:hidden bg-white dark:bg-[#09090b] border-b border-gray-100 dark:border-zinc-800 px-4 pt-2 pb-6 space-y-4 shadow-xl overflow-hidden"
          >
            {navLinks.map((link) => (
              <Link
                key={link.path}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-500 dark:text-zinc-400 text-sm leading-relaxed max-w-xs font-medium">
            ...
            <div className="mt-8 flex space-x-4">
               {[Linkedin, Twitter, Facebook, Instagram].map((Icon, i) => (
                 <motion.div key={i} whileHover={{ y: -5, scale: 1.1 }}>
                   <a href="#" className="block p-2.5 bg-gray-50 dark:bg-zinc-800/50 rounded-xl hover:bg-lime-50 dark:hover:bg-lime-900/10 text-gray-400 dark:text-zinc-500 hover:text-[#84CC16] transition-all">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-500 dark:text-zinc-400 font-bold">
              <li><Link to="/about" className="hover:text-[#84CC16] transition-colors flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-[#5D3A1A] dark:bg-zinc-100 mr-2" />About Us</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-500 dark:text-zinc-400 font-bold">
              ...
              <li className="flex items-start"><Phone className="w-5 h-5 mr-3 text-[#84CC16] shrink-0" /> +91 99340 44777</li>
              <li className="flex items-start"><MapPin className="w-5 h-5 mr-3 text-[#84CC16] shrink-0" /> Sutahata, East Midnapore,<br/>West Bengal, India</li>
            </ul>
          </div>
        </div>
